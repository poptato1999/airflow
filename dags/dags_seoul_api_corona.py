...
from operators.seoul_api_to_csv_operator import SeoulSpiToCsvOperator
...
with DAG(
    ...
    '''서울시 코로나19 확진자 발생동향'''
    tb_corona19_count_status = SeoulSpiToCsvOperator(
    ...
    tb_corona19_vaccine_stat_new = SeoulSpiToCsvOperator(
